...
def EFC(sets):
    ...
    external_test = np.load(
        "../CICIDDoS19/External_test/Discretized/Exp{}/external_test.npy".format(sets), allow_pickle=True
    ).astype("int")
    external_test_labels = np.load(
        "../CICIDDoS19/External_test/Discretized/Exp{}/external_test_labels.npy".format(sets), allow_pickle=True
    ).astype("int")
