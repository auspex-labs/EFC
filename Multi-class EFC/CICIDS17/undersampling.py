...
for fold in range(1, 6):
    train = pd.read_csv(f"5-fold_sets/Raw/Sets{fold}/train.csv", header=None)
    ...
    train.iloc[all_indexes, :].to_csv(f"5-fold_sets/Raw/Sets{fold}/reduced_train.csv", mode="a", header=False, index=False)
